...
io.write('\n\27[1;35m⬇Send UserName For Sudo : ارسل معرف Dev🎖...\n\27[0;39;49m')
local User_Sudo = io.read()
if User_Sudo ~= '' then
io.write('\n\27[1;31m◦ The UserNamr Is Saved : تم حفظ معرف Myth واستخراج ايدي Myth\n\27[0;39;49m')
...
io.write('\n\27[1;35m⬇Send id For Sudo : ارسل ايدي Dev🎖...\n\27[0;39;49m')
local User_Sudo = io.read()
if User_Sudo ~= '' then
io.write('\n\27[1;31m◦ The id Is Saved : تم حفظ ايدي Myth واستخراج ايدي Myth\n\27[0;39;49m')
...
Status = "انا البوت :) "
elseif redis:sismember(bot_id.."NightRang:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "Myth🎖"  
elseif redis:sismember(bot_id.."NightRang:Developer:Bot", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "Myth"  
elseif redis:sismember(bot_id.."NightRang:President:Group"..chat_id, user_id) then
...
local Text_keyboard = '• اهلا بك عزيزي Dev🎖\n في اوامرك الخاصه \n يمكنك تحكم في بوت عن طريق كيبورد ادناه '
local List_keyboard = {
{'تغيير اسم البوت'},
{'الاحصائيات'},
{'تفعيل تواصل','تعطيل تواصل'},
{'الاذاعه'},
{'مسح قائمه M','مسح قائمه My🎖'},
{'مسح المكتومين عام','مسح قائمة العام'},
{'اضف سؤال كت تويت','حذف سؤال كت تويت'},
{'حذف سؤال مقالات','اضف سؤال مقالات'},
...
send(msg.chat_id_,msg.id_,' هذا الامر خاص Dev🎖فقط')
return false
end
...
send(msg.chat_id_, msg.id_, "•  تم مسح قائمه M من البوت  ")
end
...
if text == ("قائمه My🎖") and Dev_Bots(msg) then
...
send(msg.chat_id_, msg.id_, "لا تستطيع حظر Dev🎖عام")
return false 
end
...
if Dev_Bots_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم Dev🎖عام")
return false 
end
if DeveloperBot12(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم Dev🎖عام")
...
if Dev_Bots_User(result.id_) == true then
send(msg.chat_id_, msg.id_, " Dev🎖لا تستطيع تقييد عام")
return false 
end
...
if text == ("قائمه M") and DeveloperBot(msg) then
local list = redis:smembers(bot_id.."NightRang:Developer:Bot")
if #list == 0 then
return send(msg.chat_id_, msg.id_, "• لا يوجد Myth")
end
...
if text == ("قائمه My🎖") and DeveloperBot1(msg) then
local list = redis:smembers(bot_id.."NightRang:Developer:Bot1")
if #list == 0 then
return send(msg.chat_id_, msg.id_, "• لا يوجد Myth")
end
...
if text == ("مسح قائمه M") and Dev_Bots(msg) then
redis:del(bot_id.."NightRang:Developer:Bot")
send(msg.chat_id_, msg.id_, "•  تم مسح قائمه M من البوت  ")
end
if text == ("مسح قائمه My🎖") and Dev_Bots(msg) then
...
send(msg.chat_id_, msg.id_,"-") 
send(GP_ID[2], 0,"•  تم مغادرة المجموعه بامر من Mythالبوت") 
send(msg.chat_id_, msg.id_,"•  تم مغادرة المجموعه بامر من Mythالبوت") 
...
send(msg.chat_id_, msg.id_,"• تم تعطيل الاذاعه من قبل Dev🎖!")
return false end
redis:setex(bot_id.."NightRang:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي المنشور الان\n• يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n• لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,' ارسل الان معرف Dev🎖الجديد')
return false
end
...
redis:del(bot_id..'Set:Text:Dev:Bot:id'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'تم تغيير Dev🎖\n الرجاء ارسل امر [تحديث]')
dofile('Info_Sudo.lua')  
return false
end
